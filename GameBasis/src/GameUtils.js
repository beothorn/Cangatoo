function GameUtils(){
	...
	this.applyGravity = function(element,delta,gravity){
		element.yAccelerate((delta*gravity)/1000);
	}
	
	this.wrapOnBoundaries = function(element,topLimit,bottomLimit,rightLimit,leftLimit){
	...
	this.bounceOnBoundaries = function(element,topLimit,bottomLimit,rightLimit,leftLimit){
		if(element.x+element.width>rightLimit){
	...
	this.applyFriction = function(element,delta,xFriction,yFriction){
		if(element.xSpeed>0){
